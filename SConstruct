...
opts.Add(EnumVariable('plugin', 'Plugin to build', '', ['', 'facebook']))
...
env.Append(FRAMEWORKPATH=['#plugin/' + env['plugin'] + '/lib/FBAEMKit.xcframework/' + xcframework_directory])
env.Append(FRAMEWORKPATH=['#plugin/' + env['plugin'] + '/lib/FBSDKCoreKit.xcframework/' + xcframework_directory])
env.Append(FRAMEWORKPATH=['#plugin/' + env['plugin'] + '/lib/FBSDKCoreKit_Basics.xcframework/' + xcframework_directory])
env.Append(FRAMEWORKPATH=['#plugin/' + env['plugin'] + '/lib/FBSDKShareKit.xcframework/' + xcframework_directory])
env.Append(FRAMEWORKPATH=['#plugin/' + env['plugin'] + '/lib/FBSDKLoginKit.xcframework/' + xcframework_directory])
...
sources = Glob('plugin/' + env['plugin'] + '/src/*.mm')
sources.append(Glob('plugin/' + env['plugin'] + '/src/module/*.mm'))
sources.append(Glob('plugin/' + env['plugin'] + '/src/delegates/*.mm'))
